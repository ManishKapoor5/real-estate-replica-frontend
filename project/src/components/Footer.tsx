          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-primary">Mumbai</a></li>
                <li><a href="#" className="text-gray-400 hover:text-primary">Delhi NCR</a></li>
                <li><a href="#" className="text-gray-400 hover:text-primary">Bangalore</a></li>
                <li><a href="#" className="text-gray-400 hover:text-primary">Hyderabad</a></li>
                <li><a href="#" className="text-gray-400 hover:text-primary">Pune</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-primary">Popular Searches</a></li>
                <li><a href="#" className="text-gray-400 hover:text-primary">Premium Projects</a></li>
                <li><a href="#" className="text-gray-400 hover:text-primary">New Projects</a></li>
                <li><a href="#" className="text-gray-400 hover:text-primary">Builder Properties</a></li>
                <li><a href="#" className="text-gray-400 hover:text-primary">NRI Services</a></li>
              </ul>
            </div>
